...
const Card2 = ({link,title,description, imageUrl }) => {
  return (
    <div className="w-[23rem] h-[16rem] rounded-[2rem] border-2 border-slate-200 overflow-hidden mx-4 my-4">
      ...
      <button className=' text-blue-500 font-extrabold ml-6'>{link}</button>
    </div>
  );
};
