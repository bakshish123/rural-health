    ...
    >
      <div className="container flex justify-between items-center md:py-5 md:space-x-10">
        <div className="flex justify-start lg:w-0 lg:flex-1">
          <Link to="/">
            <img
              src="https://hdfcsky.com/sky-logo-full.svg"
              alt=""
              className="h-8 md:h-9 lg:h-12 w-auto cursor-pointer"
            />
          </Link>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-60">
          ...
          <div className="flex gap-5">
            <Link to="/signup" className="">
              <button className="bg-blue-600 flex items-center shrink-0 gap-2 rounded-full   hover:bg-blue-700 bg-primary-blue hover:bg-primary-hover smooth-transition h-12 px-6">
                <span className="tracking-loose text-white">Sign Up</span>
              </button>
            </Link>
            <Link to="/login">
              <button className="w-[7rem] hover:text-white hover:bg-blue-50 items-center gap-2 rounded-full border-2 border-blue-400 h-12 px-6 bg-white">
                <span className=" text-blue-700 flex-none">
                  Login
                </span>
              </button>
            </Link>
