...
const Card = ({ heading, tagline, link }) => {
  return (
    <div className="flex flex-col rounded-3xl bg-white border-[2px] shadow-md  border-gray-300 w-[20rem] h-[15rem]">
      <div className="">
        <p className="text-2xl ml-5 mt-5 text-gray-700">{heading}</p>
